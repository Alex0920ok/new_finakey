        ...
        <tbody class="bg-white divide-y divide-gray-200">
            @foreach ($documents as $key => $document)
                <tr class="text-gray-700">
                    @if($loop->index == 0)
                        <th rowspan="12" scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
            ...
            {{-- 12. KYC CORPORATE --}}
            <tr class="text-gray-700">
                <td rowspan="3" class="border px-4 py-2">
                    Settlement
                </td>
                <td class="border px-4 py-2">
                    12. KYC CORPORATE
            ...
            <tr class="text-gray-700">
                <td class="border px-4 py-2">
                    7. Form T
                    @if($formTState >= 1)
                        <i class="fas fa-file-pdf" wire:click="exportPDF('{{$formTUuid}}', 'livewire.partials.form-t', '7. T	Declaration of beneficial ownership for trusts')" style="cursor: pointer; float: right;"></i>
                    @endif
                </td>
                <td class="border px-4 py-2">
                    @if($formTState >= 2 && in_array(auth()->user()->type, [0]))
                        Accepted
                    @else
                        <a href="{{ route('form-t', ['customerUuid' => $customerUuid]) }}">Go to form</a>
                    @endif
                </td>
                <td class="border px-4 py-2"></td>
                <td class="border px-4 py-2 justify-center">
