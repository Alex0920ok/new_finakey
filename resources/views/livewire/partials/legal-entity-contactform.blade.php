...
<div class="mb-4">
    <label for="legalEntityName" class="block text-gray-700 text-sm font-bold mb-2">Name of Legal Entity</label>
    <input type="text" id="legalEntityName" wire:model="legalEntityName" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    @error('legalEntityName') <span class="text-red-500 text-xs italic">{{ $message }}</span> @enderror
</div>

<!-- First Name Number -->
<div class="mb-4">
    <label for="website" class="block text-gray-700 text-sm font-bold mb-2">Website</label>
    <input type="text" id="website" wire:model="website" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
    @error('website') <span class="text-red-500 text-xs italic">{{ $message }}</span> @enderror
</div>
